...
TYPE_OPTIONS = (("MOBILE", "MOVÉL"), ("IMOBILE", "IMÓVEL"))


CONDITION_OPTIONS = (("NEW", "NOVO"), ("USED", "USADO"), ("DAMAGED", "DANIFICADO"))
...
class CostCenter(models.Model):
    ...
    details = models.TextField(
        null=True, blank=True, verbose_name="detalhes do centro de custo"
    )
...
class Asset(models.Model):
    ...
    model = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Modelo"
    )
    serial_number = models.CharField(
        max_length=100, blank=True, null=True, verbose_name="Número de série"
    )
    price = models.DecimalField(
        max_digits=10, decimal_places=2, null=True, blank=True, verbose_name="Preço"
    )
...
class RegisterAsset(models.Model):
    ...
    amount = models.IntegerField(
        validators=[
            MinValueValidator(1, "Não pode cadastrar com quantidade menor que 1")
        ]
    )
